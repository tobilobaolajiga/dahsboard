...
export default function GraphsUser() {
  return (
    <div className="flex mt-4">
      <div className=" bg-[#FFCBA2] mx-4 mb-2 w-[220px] h-[120px] rounded-lg font-poppins text-[#464255] pb-8 pt-2 px-4">
        ...
        />
        <p className="text-sm font-semibold mb-8 mt-4">Total Users</p>
      ...
      <SquareGraph
        approvalStat="Under Review Users"
        figure="695"
        percent="-0.56%"
        arrow="./ArrowFall.svg"
      />
      <div className=" bg-[#A9E9FF] mx-4 mb-2 w-[220px] h-[120px] rounded-lg font-poppins text-[#464255] pb-8 pt-2 px-4">
        <img
          ...
          className="relative left-[140px] pt-2"
        />
        <p className="text-sm font-semibold mb-8 mt-4">Active Users</p>
      ...
      <SquareGraph
        approvalStat="Deactivated Users"
        figure="1,219"
        percent="-1.78%"
        arrow="./ArrowFall.svg"
      />
